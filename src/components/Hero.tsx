...
const Hero: React.FC = () => (
  <Section id="home" className="relative overflow-hidden pt-16 sm:pt-18 md:pt-12">
    {/* big soft spotlight */}
    ...
    <div className="flex flex-col items-center text-center md:text-left md:grid md:grid-cols-2 md:items-center gap-10">
      <div>
        ...
        <div className="mt-8 mb-8 flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6">
          <div className="text-emerald-700 transition hover:scale-200">
          ...
          <div className="text-emerald-700 transition hover:scale-200">
            <img className="h-7 w-7 sm:h-8 sm:w-8 hover:text-black rounded" src="https://assets.basehub.com/dd0abb74/d4445fa7a68e5b557cafdfe41db79e92/alt-cover.jpg" alt="Elevenlabs" />
          </div>
          <div className="text-emerald-700 transition hover:scale-200">
            <img className="h-7 w-7 sm:h-8 sm:w-8 hover:text-black rounded" src="https://static.uppromote.com/wp-content/uploads/2025/12/heygen.webp" alt="Heygen" />
          </div>
          <div className="text-emerald-700 transition hover:scale-200">
            <img className="h-7 w-7 sm:h-8 sm:w-8 hover:text-black rounded" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Midjourney_Emblem.png/960px-Midjourney_Emblem.png" alt="Midjourney" />
          </div>
      </div>
      </div>
